...
<div class="content-page"> 
  ...
  <div class="content">
    <div class="container"> 
      ...
      <?php echo form_open(base_url() . 'index.php?user/profile/update/' , array('class' => 'form-horizontal group-border-dashed', 'enctype' => 'multipart/form-data'));?> 
      <!-- panel  -->
      <div class="col-md-6">
      ...
      <!--end col-6 -->
      <?php endforeach;?>
      <?php echo form_open(base_url() . 'index.php?user/profile/change_password/' , array('class' => 'form-horizontal group-border-dashed', 'enctype' => 'multipart/form-data'));?>
      <div class="col-md-6">
        <div class="panel panel-border panel-success">
          <div class="panel-heading">
