...
<title>IT Inventory Neohaus</title>
<!--Morris Chart CSS -->
          ...
          <ul class="nav navbar-nav navbar-right pull-right">
            ...
            <li class="dropdown"> <a href="#" class="dropdown-toggle profile waves-effect" data-toggle="dropdown" aria-expanded="true"><img  src="<?php echo $this->common_model->get_image_url('user', $this->session->userdata('user_id'));?>" class="thumb-lg img-circle img-thumbnail" alt="photo" ></a>
              <ul class="dropdown-menu">
                <li><a href="<?php echo base_url();?>index.php?user/manage_profile"><i class="fa fa-user" aria-hidden="true"></i> Profile</a></li>
                <li><a href="<?php echo base_url();?>index.php?user/manage_profile"><i class="fa fa-lock" aria-hidden="true"></i> Change Password</a></li>
