<?php echo form_open(base_url() . 'index.php?admin/accessories/add/' , array('class' => 'form-horizontal group-border-dashed', 'enctype' => 'multipart/form-data'));?>

<h4 class="text-center">Add new accessories</h4>
<hr>
<div class="form-group">
  <label class="col-sm-3 control-label">Accessories Name</label>
  <div class="col-sm-6">
    <input type="text"  name="accessories_name" class="form-control" required placeholder="Enter name" />
  </div>
  <!-- End col-6 --> 
</div>
<!-- end form -group -->
...
<div class="form-group">
  ...
  <div class="col-sm-6">
    <input type="text"  name="description" class="form-control"  placeholder="Enter accessories description" />
  </div>
  <!-- End col-6 --> 
</div>
<!-- end form -group -->
