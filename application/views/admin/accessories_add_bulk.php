...
<div class="content">
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        <div class="card-box"> <?php echo form_open(base_url() . 'index.php?admin/accessories_bulk_add/add/' , array('class' => 'form-horizontal group-border-dashed form-inline', 'enctype' => 'multipart/form-data'));?>
          <h4 class="text-center">Add Bulk Accessories</h4>
          <hr>
          <div class="row">          
          ...
          <table class="m-t-30 table" id="data_table" cellpadding="10px;">
            <thead>
              ...
              <th>Row (add/remove)</th>
                <th>Accessories Name<br>
                  <div class="checkbox checkbox-success">
                    <input id="same_accessories_name" type="checkbox" class="same_accessories_name">
                    <label for="checkbox-all">All Same</label>
                  </div>
                </th>
                <th>Accessories Description<br>
                  <div class="checkbox checkbox-success">
            ...
            <tbody>
              ...
              <tr id="row_tr" style="height:40px;">
                ...
                <td style="padding-right:5px;"><input type="text"  name="accessories_name[]" class="form-control input-sm accessories_name" required placeholder="Enter name" /></td>
...
<script type="text/javascript" src="assets/plugins/parsleyjs/dist/parsley.min.js"></script> 
    ...
    <script type="text/javascript">
    // computer_name
      $(".accessories_name").keyup(function(){
        if($("#same_accessories_name").is(':checked'))
      {
        var cv=$(this).val();
        $(".accessories_name").val(cv);
      }
    });
  // description
