...
?>
<?php echo form_open(base_url() . 'index.php?admin/access/update/'.$param2 , array('class' => 'form-horizontal group-border-dashed', 'enctype' => 'multipart/form-data'));?>

<h4 class="text-center">Edit access information</h4>
<hr>
...
<div class="form-group">
  ...
  <div class="col-sm-6">
    <input type="text"  name="access_name" value="<?php echo $row['access_name'];?>" class="form-control" required placeholder="Enter access name" />
  </div>
  <!-- End col-6 --> 
</div>
<!-- end form -group -->
