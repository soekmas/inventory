...
?>
<?php echo form_open(base_url() . 'index.php?admin/manage_user/update/'.$param2 , array('class' => 'form-horizontal group-border-dashed', 'enctype' => 'multipart/form-data'));?>
...
<div class="form-group">
  ...
  <div class="col-sm-6 ">
    <select  class="form-control"  name="role" required>
      ...
      <option value="user"  <?php if($row['role']=="user"){ echo "selected"; }?>>Regular User</option>
    </select>
  </div>
  <!-- End col-6 --> 
</div>
