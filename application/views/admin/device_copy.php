...
?>
<?php echo form_open(base_url() . 'index.php?admin/device/add/'.$param2 , array('class' => 'form-horizontal group-border-dashed', 'enctype' => 'multipart/form-data'));?>

<h4 class="text-center">Copy device information</h4>
<hr>
...
<div class="form-group">
  ...
  <div class="col-sm-6">
    <input type="text"  name="device_name" value="Copy of <?php echo $row['device_name'];?>" class="form-control" required placeholder="Enter name" />
  </div>
  <!-- End col-6 --> 
</div>
<!-- end form -group -->
