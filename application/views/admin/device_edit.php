...
<h4 class="text-center">Update device information</h4>
<hr>
...
<div class="form-group">
  ...
  <div class="col-sm-6">
    <input type="text"  name="device_name" value="<?php echo $row['device_name'];?>" class="form-control" required placeholder="Enter name" />
  </div>
  <!-- End col-6 --> 
</div>
<!-- end form -group -->
