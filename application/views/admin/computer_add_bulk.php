...
<div class="content">
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        <div class="card-box"> <?php echo form_open(base_url() . 'index.php?admin/computer_bulk_add/add/' , array('class' => 'form-horizontal group-border-dashed form-inline', 'enctype' => 'multipart/form-data'));?>
          <h4 class="text-center">Add Bulk Computers</h4>
          <hr>
          <div class="row">
  ...
  <!-- End col-6 --> 
  <div class="col-sm-2 ">
    <select  class="form-control input-sm"  name="ram">
          ...
          <table class="m-t-30 table" id="data_table" cellpadding="10px;">
              ...
              <th>Row (add/remove)</th>
                <th>Computer Name<br>
                  <div class="checkbox checkbox-success">
                    <input id="same_pc_name" type="checkbox" class="same_pc_name">
                    <label for="checkbox-all">All Same</label>
                  </div>
                </th>
                <th>Computer Description<br>
                  <div class="checkbox checkbox-success">
                ...
                <br>
                  <div class="checkbox checkbox-success">
                    <input id="same_processor" type="checkbox" class="same_processor" checked>
                    <label for="checkbox-all">All Same</label>
                  </div>
                </th>                
            ...
            <tbody>
              ...
              <td><input type="button" id='add_row' class="btn btn-default btn-custom" value="+" onClick="$(this).closest('tr').clone(true).insertAfter($(this).closest('tr'));">
                ...
                <td style="padding-right:5px;"><input type="text"  name="computer_name[]" class="form-control input-sm computer_name" required placeholder="Enter name" /></td>
                ...
                <td style="padding-right:5px;"><input type="text"  name="processor[]" class="form-control input-sm processor"  placeholder="Enter processor" /></td>                
                <td style="padding-right:5px;">
                    <select  class="form-control input-sm select2"  name="os_id[]" >
                      <?php
...
<script type="text/javascript" src="assets/plugins/parsleyjs/dist/parsley.min.js"></script> 
    ...
    <script type="text/javascript">
    // computer_name
      $(".computer_name").keyup(function(){
        if($("#same_pc_name").is(':checked'))
      {
        var cv=$(this).val();
        $(".computer_name").val(cv);
      }
    });
  // description
