...
?>
<?php echo form_open(base_url() . 'index.php?admin/accessories/add/'.$param2 , array('class' => 'form-horizontal group-border-dashed', 'enctype' => 'multipart/form-data'));?>

<h4 class="text-center">Copy accessories information</h4>
<hr>
<div class="form-group">
  <label class="col-sm-3 control-label">Accessories Name</label>
  <div class="col-sm-6">
    <input type="text"  name="accessories_name" value="Copy of <?php echo $row['accessories_name'];?>" class="form-control" required placeholder="Enter name" />
  </div>
  <!-- End col-6 --> 
</div>
<!-- end form -group -->
