    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="card-box table-responsive">
          <button onclick="show_modal('<?php echo base_url() . 'index.php?admin/popup_modal/computer_add' . "'";?>)" class="btn btn-success waves-effect waves-light"><i class="fa fa-plus"></i> Add New</button>
          <a href="<?php echo base_url() . 'index.php?admin/computer_bulk_add'?>" class="btn btn-success waves-effect waves-light"><i class="fa fa-plus"></i> Add Bulk Computer</a>
          <br>
          <br>
            ...
            <div class="tab-pane active" id="server">
              ...
              ?>
                  <tr id='<?php echo $server['id'];?>'>
                    ...
                    <td><div class="btn-group m-b-20"> <a title="Edit" class="btn btn-icon waves-effect waves-light btn-info btn-xs" onclick="show_modal('<?php echo base_url() . 'index.php?admin/popup_modal/computer_detail/'. $server['id'] . "'";?>)"><i class="fa fa-info-circle" aria-hidden="true"></i></a> <a title="Edit" class="btn btn-icon waves-effect waves-light btn-success btn-xs" onclick="show_modal('<?php echo base_url() . 'index.php?admin/popup_modal/computer_copy/'. $server['id'] . "'";?>)"><i class="fa fa-files-o" aria-hidden="true"></i></a> <a title="Edit" class="btn btn-icon waves-effect waves-light btn-inverse btn-xs" onclick="show_modal('<?php echo base_url() . 'index.php?admin/popup_modal/computer_edit/'. $server['id'] . "'";?>)"><i class="fa fa-pencil"></i></a> <a title="Delete" class="btn btn-icon waves-effect waves-light btn-danger btn-xs" onclick="delete_computer(<?php echo $server['id'];?>)" href="#" class="delete"><i class="fa fa-remove"></i></a> </div></td>
                  </tr>
                  <?php endforeach;?>
                </tbody>
              </table>
            ...
            <div class="tab-pane" id="desktop">
              ...
              ?>
                  <tr id='<?php echo $desktop['id'];?>'>
                    ...
                    <td><div class="btn-group m-b-20"> <a title="Edit" class="btn btn-icon waves-effect waves-light btn-info btn-xs" onclick="show_modal('<?php echo base_url() . 'index.php?admin/popup_modal/computer_detail/'. $desktop['id'] . "'";?>)"><i class="fa fa-info-circle" aria-hidden="true"></i></a> <a title="Edit" class="btn btn-icon waves-effect waves-light btn-success btn-xs" onclick="show_modal('<?php echo base_url() . 'index.php?admin/popup_modal/computer_copy/'. $desktop['id'] . "'";?>)"><i class="fa fa-files-o" aria-hidden="true"></i></a> <a title="Edit" class="btn btn-icon waves-effect waves-light btn-inverse btn-xs" onclick="show_modal('<?php echo base_url() . 'index.php?admin/popup_modal/computer_edit/'. $desktop['id'] . "'";?>)"><i class="fa fa-pencil"></i></a> <a title="Delete" class="btn btn-icon waves-effect waves-light btn-danger btn-xs" onclick="delete_computer(<?php echo $desktop['id'];?>)" href="#" class="delete"><i class="fa fa-remove"></i></a> </div></td>
                  </tr>
                  <?php endforeach;?>
                </tbody>
              </table>
            ...
            <div class="tab-pane active" id="laptop">
              ...
              ?>
                  <tr id='<?php echo $laptop['id'];?>'>
                    ...
                    <td><div class="btn-group m-b-20"> <a title="Edit" class="btn btn-icon waves-effect waves-light btn-info btn-xs" onclick="show_modal('<?php echo base_url() . 'index.php?admin/popup_modal/computer_detail/'. $laptop['id'] . "'";?>)"><i class="fa fa-info-circle" aria-hidden="true"></i></a> <a title="Edit" class="btn btn-icon waves-effect waves-light btn-success btn-xs" onclick="show_modal('<?php echo base_url() . 'index.php?admin/popup_modal/computer_copy/'. $laptop['id'] . "'";?>)"><i class="fa fa-files-o" aria-hidden="true"></i></a> <a title="Edit" class="btn btn-icon waves-effect waves-light btn-inverse btn-xs" onclick="show_modal('<?php echo base_url() . 'index.php?admin/popup_modal/computer_edit/'. $laptop['id'] . "'";?>)"><i class="fa fa-pencil"></i></a> <a title="Delete" class="btn btn-icon waves-effect waves-light btn-danger btn-xs" onclick="delete_computer(<?php echo $laptop['id'];?>)" href="#" class="delete"><i class="fa fa-remove"></i></a> </div></td>
                  </tr>
                  <?php endforeach;?>
                </tbody>
              </table>
            ...
            <div class="tab-pane active" id="tablet">
              ...
              ?>
                  <tr id='<?php echo $tablet['id'];?>'>
                    ...
                    <td><div class="btn-group m-b-20"> <a title="Edit" class="btn btn-icon waves-effect waves-light btn-info btn-xs" onclick="show_modal('<?php echo base_url() . 'index.php?admin/popup_modal/computer_detail/'. $tablet['id'] . "'";?>)"><i class="fa fa-info-circle" aria-hidden="true"></i></a> <a title="Edit" class="btn btn-icon waves-effect waves-light btn-success btn-xs" onclick="show_modal('<?php echo base_url() . 'index.php?admin/popup_modal/computer_copy/'. $tablet['id'] . "'";?>)"><i class="fa fa-files-o" aria-hidden="true"></i></a> <a title="Edit" class="btn btn-icon waves-effect waves-light btn-inverse btn-xs" onclick="show_modal('<?php echo base_url() . 'index.php?admin/popup_modal/computer_edit/'. $tablet['id'] . "'";?>)"><i class="fa fa-pencil"></i></a> <a title="Delete" class="btn btn-icon waves-effect waves-light btn-danger btn-xs" onclick="delete_computer(<?php echo $tablet['id'];?>)" href="#" class="delete"><i class="fa fa-remove"></i></a> </div></td>
                  </tr>
                  <?php endforeach;?>
                </tbody>
              </table>
